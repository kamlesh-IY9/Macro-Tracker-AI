...
class _$FoodLogImpl implements _FoodLog {
  ...
  @override
  String toString() {
    return 'FoodLog(id: $id, userId: $userId, name: $name, calories: $calories, protein: $protein, carbs: $carbs, fat: $fat, timestamp: $timestamp, imageUrl: $imageUrl, isAiGenerated: $isAiGenerated)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, name, calories,
      protein, carbs, fat, timestamp, imageUrl, isAiGenerated);
...
abstract class _FoodLog implements FoodLog {
  const factory _FoodLog(
      ...
      final String? imageUrl,
      final bool isAiGenerated}) = _$FoodLogImpl;
